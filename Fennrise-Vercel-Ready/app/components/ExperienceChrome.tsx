...
export function ExperienceHeader({ active }: { active: "products" | "services" }) {
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerTop}>
        ...
        <div><Link href="/products">Products</Link><Link href="/services">Services</Link><Link href="/#about">About</Link></div>
      </div>
